...
INSERT INTO label_forms (id,vendor,product,description,type,unit_id,h_dist,v_dist,width,heigth,leftm,topm,cols,rows,sheet_id) VALUES (3,3,'Memorex','CD/DVD Label','CD/DVD Label',3,3,11.9,11.9,11.9,11.9,1.1,2.4,1,1,1);
...
INSERT INTO printers (id, name, unit_id, top_offset, left_offset) VALUES (3,'Canon S520',4,0,0);
