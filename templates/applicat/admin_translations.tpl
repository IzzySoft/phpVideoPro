...
<TABLE ALIGN="center" BORDER="0" WIDTH="100%" CELLPADDING="0" CELLSPACING="0" STYLE="margin:3">
 ...
 <TR><TD COLSPAN=2>
  <TABLE ALIGN="center" BORDER="1" CELLPADDING="2" CELLSPACING="2" Style="table-layout:fixed">
   <!-- BEGIN mtitleblock -->
 ...
 <TR><TD COLSPAN="2" BGCOLOR="#AAAAAA"><IMG SRC="{tpl_dir}0.gif" WIDTH="1" HEIGHT="1" BORDER="0"></TD></TR>
 <TR><TD COLSPAN="2" BGCOLOR="#FFFFFF"><IMG SRC="{tpl_dir}0.gif" WIDTH="1" HEIGHT="1" BORDER="0"></TD></TR>
