...
<TABLE ALIGN="center" BORDER="0" WIDTH="100%" CELLPADDING="0" CELLSPACING="0" STYLE="margin:3">
 ...
 <TR><TD COLSPAN="2" BGCOLOR="#AAAAAA"><IMG SRC="{tpl_dir}images/0.gif" WIDTH="1" HEIGHT="1" BORDER="0"></TD></TR>
 <TR><TD COLSPAN="2" BGCOLOR="#FFFFFF"><IMG SRC="{tpl_dir}images/0.gif" WIDTH="1" HEIGHT="1" BORDER="0"></TD></TR>
