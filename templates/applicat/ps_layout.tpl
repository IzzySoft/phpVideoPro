...
<TABLE STYLE="table-layout:fixed;" ALIGN="center" CELLPADDING="0" CELLSPACING="0" BORDER="0"><TR><TD>
...
<TR><TD BGCOLOR="#AAAAAA"><IMG SRC="{tpl_dir}0.gif" WIDTH="1" HEIGHT="1" BORDER="0"></TD></TR>
<TR><TD BGCOLOR="#FFFFFF"><IMG SRC="{tpl_dir}0.gif" WIDTH="1" HEIGHT="1" BORDER="0"></TD></TR>
<TR><TD STYLE="text-align:center;margin:3;"><INPUT CLASS="submit" TYPE="submit" NAME="create" VALUE="{create}"></TD></TR>
</FORM>
